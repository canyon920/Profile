...
<template>
  <div>
    ...
    <div class="chart dought1"><span class="center"> 80%</span></div>
    <DeveloperSKillModal :skill="skill" />
    <!--    </transition>-->
  </div>
</template>
<script>
import DeveloperSKillModal from "@/modal/DeveloperSKillModal";
export default {
  components: { DeveloperSKillModal },
};
</script>
